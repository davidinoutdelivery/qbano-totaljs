...
exports.install = function () {
  ...
  //F.route('/api/order/', order, [timeOut, 'post']);
  //F.route('/api/updateCart/', updateCart, [timeOut, 'put'], 2000);
  //F.route('/api/menu/', menu, [timeOut, 'get']);
  //F.route('/api/configuration/', configuration, [timeOut, 'get']);
  //F.route('/api/banners/', banners, [timeOut, 'get']);
  //F.route('/api/pointsales/', pointsales, [timeOut, 'post']);
  //F.route('/api/pointsale/', pointSale, [timeOut, 'get']);
  F.route('/api/email/', email, [timeOut, 'post']);
  //F.route('/api/promotionalCode/', promotionalCode, [timeOut, 'post']);
  //F.route('/api/pointSaleIsOpen/', pointSaleIsOpen, [timeOut, 'get']);
  //F.route('/api/addToCart/', addToCart, [timeOut, 'post'], 2000);
  //F.route('/api/changePassword/', changePassword, ['post']);
  //F.route('/api/schedule/', schedulePointSale, ['post']);
  //F.route('/api/setSchedule/', setSchedule, ['post']);
};
